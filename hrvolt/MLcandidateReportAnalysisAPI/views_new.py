                ...
                if CandidatePreferenceModel.objects.filter(user_id = getData['user_id']).exists(): 
                    ...
                    if CandidateBasicEducationDetails.objects.filter(user_id = getData['user_id']).exists():
                        ...
                        ########################################################################
                            ...
                            education_response = json.loads(educationFun(educationdata)).text
                        ...
                        ########################################################################
                            ...
                            exp_response = json.loads(experienceFun(expdata)).text
                            ...
                            tech_response = json.loads(TechnicalSkillsFun(techData)).text
                            ...
                            softSkill_response = json.loads(SoftSkillsFun(softSkillData)).text
                            ...
                            currAct_response = json.loads(curricularActivitiesFun(currActData)).text
                            ...
                            project_response = json.loads(projectFun(projectData)).text
                            ...
                            print([[tech_response["Data"]["technical_prediction_score_at_100_scale"], exp_response["Data"]["experience_score_at_100_scale"], education_response["Data"]["education_score_at_100_scale"], project_response["Data"]["Project_prediction_score_at_100_scale"], softSkill_response["Data"]["soft_skill_score_at_100_scale"], currAct_response["Data"]["curricular_activites_score_at_100_scale"]]])
                        ...
                        res = {"Message": "Education is not found for this User. Kindly add record in resume form!"}
                        return Response(res, status=status.HTTP_401_UNAUTHORIZED)


                else:
                    res = {"Message": "job position and job level is not found for this User. Kindly add record in preference form!"}
                    return Response(res, status=status.HTTP_401_UNAUTHORIZED)
            ...
            if JobLevelModel.objects.filter(job_level_id = getData['job_level_id']).exists():
                ...
                if EducationModel.objects.filter(education_id = getData['education_id']).exists():
                    ...
                    if EducationFieldModel.objects.filter(education_field_id = getData['education_field_id']).exists():
                        ...
                        res = {"Message": "Education Field is not found",
                        "Data":{
                            "job_level_id" : getData["job_level_id"],
                            "job_level_name" : JobLevelModel.objects.get(job_level_id = getData["job_level_id"]).job_level_name,
                            "education_id" : getData["education_id"],
                ...
                res = {"Message": "Job level is not found"}
                return Response(res, status=status.HTTP_401_UNAUTHORIZED)
...
def TechnicalSkillsFun(getData):
                ...
                if JobPositionModel.objects.filter(job_position_id = getData['job_position_id']).exists():
                    ...
                    if CandidateTechnicalskillsModel.objects.filter(user_id = getData['user_id']).exists():
                        ...
                        if not candidateReportHavetoTechSkillModel.objects.filter(user_id = getData['user_id'],candidate_report_analysis_id = getData["candidate_report_analysis_id"]).exists() or not candidateReportOptionalTechSkillModel.objects.filter(user_id = getData['user_id'], candidate_report_analysis_id = getData["candidate_report_analysis_id"]).exists():
                            ...
                            res = {"Message": "Have to and optional skills already exists with this report"}
                            return Response(res, status=status.HTTP_401_UNAUTHORIZED)
...
def curricularActivitiesFun(getData):
