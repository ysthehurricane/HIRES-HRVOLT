...
import {userRegisterCall, userEmailVerificationCall} from '../../../actions/userAction'
      ...
      try {
        ...
        if('errorMsg' in res){
          ...
          if('id' in res){
            ...
            const resEmail = await dispatch( 
              userEmailVerificationCall(sendEmailData)  
            )

            setLoading(false)

            if('id' in resEmail && !loading){
            ...
            setStatus("Something goes wrong during registration !!")            
          }
          ...
          if (Object.keys(res).length === 0) {
            ...
            const errormsg = Object.values(res)[0];
            setStatus(errormsg)
          }
