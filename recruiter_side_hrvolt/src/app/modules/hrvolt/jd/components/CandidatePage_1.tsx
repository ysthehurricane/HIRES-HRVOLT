...
const CandidatePage: React.FC<Props> = ({className, chartColor, chartHeight}) => {

  const [modalShow, setModalShow] = React.useState(false);

  // const { isLoggedIn, userDetail, initialUserDetail, authTokens  } = useAuth();

  // console.log("is Login: ", isLoggedIn)
  // console.log("User Details: ", userDetail)
  // console.log("Initial User Details: ", initialUserDetail)
